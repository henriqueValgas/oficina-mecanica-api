...
public class ClienteSpecification {
    ...
    public static Specification<Pessoa> ativo() {
        return (root, query, cb) ->
                cb.isTrue(root.get("ativo"));
    }

    public static Specification<Pessoa> nomeContem(String nome){
    ...
    public static Specification<Pessoa> cpfIgual(String cpf){
